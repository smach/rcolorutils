...
You can see a searchable table with all colors by running the `create_color_table()` function. It takes one argument, desired length of table pages, which defaults to 25.
